"""
Mask Drawing Tool for Manual Polygon Selection on Map
...
path = ""
exten = ""
file_path = f"{path}tilefrac10{exten}.nc"
...
clear_btn = tk.Button(button_frame, text="Clear", command=clear_view, height = 1, width = 12)
clear_btn.pack(side=tk.LEFT, padx=2)

reset_btn = tk.Button(button_frame, text="Reset View", command=reset_view, height = 1, width = 12)
reset_btn.pack(side=tk.LEFT, padx=2)

undo_btn = tk.Button(button_frame, text="Undo Last Point", command=undo_last_point, height = 1, width = 12)
undo_btn.pack(side=tk.LEFT, padx=2)

help_btn = tk.Button(button_frame, text="Help", command=show_help, height=1, width=12)
help_btn.pack(side=tk.RIGHT, padx=2)

save_btn = tk.Button(button_frame, text="Save As", command=save_as, height=1, width=12)
save_btn.pack(side=tk.RIGHT, padx=2)

isticked = tk.IntVar()
chk = tk.Checkbutton(clear_frame, text='Clear on save', variable=isticked)
